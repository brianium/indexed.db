...
var G__2009 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__2009,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__2009;
}
}));
...
var len__4864__auto___2014 = arguments.length;
var i__4865__auto___2015 = (0);
while(true){
if((i__4865__auto___2015 < len__4864__auto___2014)){
args__4870__auto__.push((arguments[i__4865__auto___2015]));

var G__2016 = (i__4865__auto___2015 + (1));
i__4865__auto___2015 = G__2016;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq2011){
var G__2012 = cljs.core.first.call(null,seq2011);
var seq2011__$1 = cljs.core.next.call(null,seq2011);
var G__2013 = cljs.core.first.call(null,seq2011__$1);
var seq2011__$2 = cljs.core.next.call(null,seq2011__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2012,G__2013,seq2011__$2);
}));
...
var map__2018 = m;
var map__2018__$1 = cljs.core.__destructure_map.call(null,map__2018);
var file = cljs.core.get.call(null,map__2018__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__2018__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__2018__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__2017_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__2017_SHARP_));
...
var temp__5753__auto___2019 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___2019)){
var message_2020 = temp__5753__auto___2019;
cljs.core.println.call(null,message_2020);
} else {
}
...
var temp__5753__auto___2021 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___2021)){
var message_2022 = temp__5753__auto___2021;
cljs.core.println.call(null,message_2022);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__2023 = output_dir;
...
var G__2024 = exception.stack;
var G__2024__$1 = (((G__2024 == null))?null:clojure.string.split_lines.call(null,G__2024));
var G__2024__$2 = (((G__2024__$1 == null))?null:cljs.core.get.call(null,G__2024__$1,depth));
if((G__2024__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__2024__$2);
}
} else {
...
var vec__2025 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__2025,(0),null);
var column = cljs.core.nth.call(null,vec__2025,(1),null);
var vec__2028 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__2028,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__2028,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__2028,(2),null);
...
var m__$1 = (function (){var G__2031 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__2031__$1 = (((G__2031 instanceof cljs.core.Keyword))?G__2031.fqn:null);
switch (G__2031__$1) {
case "fail":
...
var G__2035 = (function (){var G__2034 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__2034);
} else {
return G__2034;
}
})();
...
return cljs.core.vary_meta.call(null,G__2036,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__2040 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__2040,(0),null);
var types = vec__2040;
...
return cljs.core.map.call(null,(function (p__2043){
var vec__2044 = p__2043;
var ns = cljs.core.nth.call(null,vec__2044,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__2044,(1),null);
return (function (){
...
var G__2047 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__2047__$1 = (((G__2047 instanceof cljs.core.Keyword))?G__2047.fqn:null);
switch (G__2047__$1) {
case "async":
...
var seq__2048 = cljs.core.seq.call(null,vars__$1);
var chunk__2049 = null;
var count__2050 = (0);
var i__2051 = (0);
while(true){
if((i__2051 < count__2050)){
var v = cljs.core._nth.call(null,chunk__2049,i__2051);
var temp__5753__auto___2053 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5753__auto___2053)){
var t_2054 = temp__5753__auto___2053;
each_fixture_fn.call(null,((function (seq__2048,chunk__2049,count__2050,i__2051,t_2054,temp__5753__auto___2053,v,each_fixture_fn,G__2047,G__2047__$1,env,once_fixtures,each_fixtures,vec__2044,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_2054)));
});})(seq__2048,chunk__2049,count__2050,i__2051,t_2054,temp__5753__auto___2053,v,each_fixture_fn,G__2047,G__2047__$1,env,once_fixtures,each_fixtures,vec__2044,ns,vars__$1))
);
} else {
}


var G__2055 = seq__2048;
var G__2056 = chunk__2049;
var G__2057 = count__2050;
var G__2058 = (i__2051 + (1));
seq__2048 = G__2055;
chunk__2049 = G__2056;
count__2050 = G__2057;
i__2051 = G__2058;
...
var temp__5753__auto__ = cljs.core.seq.call(null,seq__2048);
if(temp__5753__auto__){
var seq__2048__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__2048__$1)){
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__2048__$1);
var G__2059 = cljs.core.chunk_rest.call(null,seq__2048__$1);
var G__2060 = c__4679__auto__;
var G__2061 = cljs.core.count.call(null,c__4679__auto__);
var G__2062 = (0);
seq__2048 = G__2059;
chunk__2049 = G__2060;
count__2050 = G__2061;
...
var v = cljs.core.first.call(null,seq__2048__$1);
var temp__5753__auto___2063__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5753__auto___2063__$1)){
var t_2064 = temp__5753__auto___2063__$1;
each_fixture_fn.call(null,((function (seq__2048,chunk__2049,count__2050,i__2051,t_2064,temp__5753__auto___2063__$1,v,seq__2048__$1,temp__5753__auto__,each_fixture_fn,G__2047,G__2047__$1,env,once_fixtures,each_fixtures,vec__2044,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_2064)));
});})(seq__2048,chunk__2049,count__2050,i__2051,t_2064,temp__5753__auto___2063__$1,v,seq__2048__$1,temp__5753__auto__,each_fixture_fn,G__2047,G__2047__$1,env,once_fixtures,each_fixtures,vec__2044,ns,vars__$1))
);
} else {
}


var G__2065 = cljs.core.next.call(null,seq__2048__$1);
var G__2066 = null;
var G__2067 = (0);
var G__2068 = (0);
seq__2048 = G__2065;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2047__$1)].join('')));
