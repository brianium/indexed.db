...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_3025);
...
var len__4864__auto___3029 = arguments.length;
var i__4865__auto___3030 = (0);
while(true){
if((i__4865__auto___3030 < len__4864__auto___3029)){
args__4870__auto__.push((arguments[i__4865__auto___3030]));

var G__3031 = (i__4865__auto___3030 + (1));
i__4865__auto___3030 = G__3031;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq3026){
var G__3027 = cljs.core.first.call(null,seq3026);
var seq3026__$1 = cljs.core.next.call(null,seq3026);
var G__3028 = cljs.core.first.call(null,seq3026__$1);
var seq3026__$2 = cljs.core.next.call(null,seq3026__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3027,G__3028,seq3026__$2);
}));
...
var vec__3032 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__3032,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__3032,(1),null);
var G__3035 = cljs.core.PersistentArrayMap.EMPTY;
var G__3035__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__3035,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__3035);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__3035__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__3035__$1;
}
} else {
...
return (function() { 
var G__3039__delegate = function (klass,contents){
var vec__3036 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__3036,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__3036,(1),null);
...
var G__3039 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__3040__i = 0, G__3040__a = new Array(arguments.length -  1);
while (G__3040__i < G__3040__a.length) {G__3040__a[G__3040__i] = arguments[G__3040__i + 1]; ++G__3040__i;}
  contents = new cljs.core.IndexedSeq(G__3040__a,0,null);
} 
return G__3039__delegate.call(this,klass,contents);};
G__3039.cljs$lang$maxFixedArity = 1;
G__3039.cljs$lang$applyTo = (function (arglist__3041){
var klass = cljs.core.first(arglist__3041);
var contents = cljs.core.rest(arglist__3041);
return G__3039__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__3045){
var map__3046 = p__3045;
var map__3046__$1 = cljs.core.__destructure_map.call(null,map__3046);
var ns = cljs.core.get.call(null,map__3046__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__3046__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__3047){
var map__3048 = p__3047;
var map__3048__$1 = cljs.core.__destructure_map.call(null,map__3048);
var actual = cljs.core.get.call(null,map__3048__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__3048__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__3049){
var map__3050 = p__3049;
var map__3050__$1 = cljs.core.__destructure_map.call(null,map__3050);
var expected = cljs.core.get.call(null,map__3050__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__3050__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__3051_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__3051_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__3053 = cljs_test_display.core.current_var_info.call(null);
var map__3053__$1 = cljs.core.__destructure_map.call(null,map__3053);
var info = map__3053__$1;
var name = cljs.core.get.call(null,map__3053__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__3053__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__3053__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__3052_SHARP_){
return cljs.core.cons.call(null,node,p1__3052_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__3054){
var map__3055 = p__3054;
var map__3055__$1 = cljs.core.__destructure_map.call(null,map__3055);
var m = map__3055__$1;
var fail = cljs.core.get.call(null,map__3055__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__3055__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__3055__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__3055__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5753__auto___3056 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___3056)){
var message_3057 = temp__5753__auto___3056;
cljs.core.println.call(null,message_3057);
} else {
}
...
var temp__5753__auto___3058 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___3058)){
var message_3059 = temp__5753__auto___3058;
cljs.core.println.call(null,message_3059);
} else {
}
